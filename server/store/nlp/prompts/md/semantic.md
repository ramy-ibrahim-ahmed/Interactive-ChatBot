...
2. `__chat__`: This agent responds directly to user questions without searching. Route to this agent if the question can be answered using the existing chat history or it is just thanking or greatting message.
